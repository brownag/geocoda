...
You can install the development version of geocoda from [GitHub](https://github.com/brownag/geocoda) with:
...
- **`gc_expand_bounds()`** - Generate a grid of valid compositions from constraints
- **`gc_resample_compositions()`** - Draw samples from valid compositions (uniform or soil texture)
...
If you use this package in your research, please cite it. Run `citation("geocoda")` for citation information.
...
- Egozcue, J. J., Pawlowsky-Glahn, V., Mateu-Figueras, G., & Barceló-Vidal, C. (2003).
  ...
  *Mathematical Geology*, 35(3), 279–300.
  [https://doi.org/10.1023/A:1023818214614](https://doi.org/10.1023/A:1023818214614)

- Chilès, J. P., & Delfiner, P. (2012). *Geostatistics: Modeling Spatial Uncertainty* (2nd ed.).
  Wiley, Hoboken, NJ.
  [https://doi.org/10.1002/9781118383087](https://doi.org/10.1002/9781118383087)
...
- Tolosana-Delgado, R., Mueller, U., & van den Boogaart, K. G. (2012).
  ...
  *Mathematical Geosciences*, 44(4), 465–479.
  [https://doi.org/10.1007/s11004-011-9363-4](https://doi.org/10.1007/s11004-011-9363-4)
